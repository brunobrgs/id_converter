class DatabaseUpdater
  ...
  def models
    [
      ...
      ProductMatrix, RemoteRequest, Repayment, RequestItem, ReservedProduct,
      ReservedProductItem, Role, SellInternetItem, SellPlanItem, SellPlanItemService,
      ServiceOperation, ServiceOperationItem, ServiceTariff, Sms, StockAdjust,
      StockAdjustEntry, StockAdjustOutput, StockMovement, StockMovementItem,
